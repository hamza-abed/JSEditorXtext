 ...
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.javaScriptEditor.impl.DomainmodelImpl#getElements <em>Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DomainmodelImpl extends MinimalEObjectImpl.Container implements Domainmodel
{
  ...
  {
    return JavaScriptEditorPackage.Literals.DOMAINMODEL;
  }
  ...
  public EList<AbstractElement> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<AbstractElement>(AbstractElement.class, this, JavaScriptEditorPackage.DOMAINMODEL__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case JavaScriptEditorPackage.DOMAINMODEL__ELEMENTS:
