 ...
 * @generated
 */
public class JavaScriptEditorSwitch<T> extends Switch<T>
{
  /**
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case JavaScriptEditorPackage.ABSTRACT_ELEMENT:
      {
      ...
      case JavaScriptEditorPackage.PROGRAM_START:
      {
        ...
        if (result == null) result = caseAbstractElement(programStart);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
